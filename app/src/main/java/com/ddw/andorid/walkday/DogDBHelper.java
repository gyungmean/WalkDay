...
public class DogDBHelper extends SQLiteOpenHelper {
    ...
    private final static String DB_NAME = "dog_db";
    public final static String TABLE_NAME = "dob_table";
    public final static String COL_ID = "_id";
    public final static String COL_NAME = "date";
    public final static String COL_BIRTH = "distance";
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "create table " + TABLE_NAME + " ( " + COL_ID + " integer primary key autoincrement,"
                + COL_NAME + " TEXT, " + COL_BIRTH + " TEXT, " + COL_WEIGHT + " FLOAT, "
